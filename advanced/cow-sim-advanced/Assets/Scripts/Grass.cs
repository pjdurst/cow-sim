...
public class Grass : MonoBehaviour
{
    ...
    public float maxScale = 5f;  // Maximum scale when fully grown
    ...
    void Start()
    {
        Debug.Log("Hi, I am grass at " + transform.position);
    ...
    void Update()
    {
        ...
        if (amount < maxAmount)
        {
            ...
            if (growTimer >= growRate)
            {
                amount++;
                growTimer = 0f;
                Debug.Log("I am regrowing, amount: " + amount);
